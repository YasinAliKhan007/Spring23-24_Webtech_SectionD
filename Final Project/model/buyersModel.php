...
{
 $connection = getConnection();
 $sql = "insert into buyers (fullname, username, email, password, confirmpassword, dateofbirth) values ('{$user['fullname']}', '{$user['username']}', '{$user['email']}', '{$user['password']}', '{$user['confirmpassword']}', '{$user['dateofbirth']}')";
